...
sealed interface Expression {
    ...
    data class Assignment(val identifier: Token.Literal.Identifier, val value: Simple) : Expression, Complex

    data class Call(val identifier: Token.Literal.Identifier, val arguments: List<Simple>) : Expression, Complex
    ...
    sealed interface Declaration : Expression, Complex {
        ...
        data class Function(val name: String, val parameters: List<String>, val body: Expression) : Declaration
    }
